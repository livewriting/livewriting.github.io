...
*/
    ...
    function init(){
       ...
       // FIME (Text vIsualization for Musical Expression
        var BOOK="Hello, World. This is fft spectrum testing. \nMake sure you \"Allow\" for microphone permissions in your web browser. \nSing or whistle some notes and see how the text property changes when you sing high notes and low notes.";
     //   var BOOK="H";
        var fontSize = 32;
