...
var DEBUG = false;    
    ...
    if (! window.AudioContext) {
        if (! window.webkitAudioContext) {
            alert('no audiocontext found, please use web browser that supports Web Audio API. ');
        }
  ...
  //      sourceNode.noteOff(0);
    ...
    function init(){
       ...
       // FIME (Text vIsualization for Musical Expression
        var BOOK="Hello, World. This is time domain data testing. \nMake sure you \"Allow\" for microphone permissions in your web browser. \nTime domain signal displaces vertices of the letters. ";
     //   var BOOK="H";
        var fontSize = 32;
